"""
Django settings for mithilesh1234_2 project.
...
ROOT_URLCONF = 'mithilesh1234_2.urls'
...
WSGI_APPLICATION = 'mithilesh1234_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mithilesh1234_2 API",
    "DESCRIPTION": "API documentation for mithilesh1234_2 App",
    "VERSION": "v1",
}
